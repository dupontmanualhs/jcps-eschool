...
trait HtmlTypedField extends TypedField[NodeSeq] {
 ...
 *
 */
class HtmlField[OwnerType <: Record[OwnerType]](rec: OwnerType)
    extends Field[NodeSeq, OwnerType] with MandatoryTypedField[NodeSeq] with HtmlTypedField {
  def owner = rec
